...
public:
    [[nodiscard]] static std::optional<Greeks> calculate(double K, double T, OptionType type, double spotPrice, double riskFreeRate, const IVolatilitySurface& volSurface);
